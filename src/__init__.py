...
walls_danger_zones = []
for wall in walls:
    danger_zone = SquareObject.create_square(position=wall.position, width=wall.width+40, height=wall.height+40, radians=wall.radians, danger_zone=True)
...
walls_danger_zones.append(danger_zone_cross_1)
walls_danger_zones.append(danger_zone_cross_2)
