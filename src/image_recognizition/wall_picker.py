...
class WallPicker:
    ...
    def _pick_four_points(self, window_name, num_points) -> SquareObject:
        if num_points == 4:
            self.points = []
    ...
    def _click_cross_one(self):
        ...
        return self._pick_four_points("One rectangle from cross", 4)
